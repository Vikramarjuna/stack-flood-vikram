...
public class AuthFilter implements Filter{
	...
	private static final String AUTH_URL_LIST = "authPatterns";

    private Set<String> bypassUrls = new HashSet<String>();
    private Set<String> authUrls = new HashSet<String>();
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        String authUrlString = filterConfig.getInitParameter(AUTH_URL_LIST);
        if (authUrlString != null) {
            authUrls.addAll(Arrays.asList(authUrlString.split(",")));
        }
	}
